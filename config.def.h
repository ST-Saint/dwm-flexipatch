...
static const Key keys[] = {
        ...
        #if SHIFTBOTH_PATCH
        { MODKEY|ShiftMask|ControlMask, XK_Left,       shiftboth,              { .i = -1 } }, // note keybinding conflict with focusadjacenttag tagandviewtoleft
        { MODKEY|ShiftMask|ControlMask, XK_Right,      shiftboth,              { .i = +1 } }, // note keybinding conflict with focusadjacenttag tagandviewtoright
